...
import ru.hse.amaltheateam.wallets.web.mappers.OperationMapper;
import ru.hse.amaltheateam.wallets.web.repository.CategoryRepository;
import ru.hse.amaltheateam.wallets.web.repository.OperationRepository;
...
public class OperationService {
    ...
    public OperationResponseDTO update(UpdateOperationRequestDTO operationRequestDTO, Long id) {
        Operation operation = operationRepository.findById(id).orElseThrow();
